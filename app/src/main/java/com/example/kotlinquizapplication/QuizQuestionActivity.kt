...
import com.example.kotlinquizapplication.model.Question
...
class QuizQuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setQuestion() {
        ...
        binding.tvQuestionName.text = question!!.question
            ...
            R.id.btnSubmit -> {
                if (mSelectedOptionPosition == 0) {
                    ...
                    if (question!!.correctAnswer != mSelectedOptionPosition) {
                        ...
                        answerView(mSelectedOptionPosition, R.drawable.correct_answer_bg)
